      ...
      {needRefresh && (
        <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-[100]">
          <div className="flex items-start gap-3">
            <span className="flex-shrink-0 w-9 h-9 rounded-lg bg-[#23388F] flex items-center justify-center">
          ...
          <div className="mt-3 flex gap-2">
            <button
              ...
              className="flex-1 bg-[#23388F] text-white text-sm font-medium py-2 px-3 rounded-md hover:bg-[#1a2a6b] transition-colors"
            >
              Update now
            </button>
            <button
